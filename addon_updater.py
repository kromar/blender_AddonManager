...
class AddonUpdater_OT_SearchUpdates(Operator):
    ''' Look for a new Addon version on Github '''
    bl_idname = "addon_updater.check_updates"
...
""" class BAddonManager_OT_UpdateAddon(Operator):
    ''' update addon '''
    bl_idname = "addon_updater.update_addon"
